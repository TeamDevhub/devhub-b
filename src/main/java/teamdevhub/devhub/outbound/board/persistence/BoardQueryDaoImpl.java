...
//import teamdevhub.devhub.outbound.common.util.OrderByUtil; 
//
//@Repository
...
//    					);
//    	
//    	List<String> boardGuidList = commonQuery.clone()
//                .select(boardEntity.boardGuid)
////                .orderBy(boardEntity.registeredDate.desc())
//                .orderBy(OrderByUtil.getAllOrderSpecifiers(pageable.getSort(), boardEntity))
...
//                .fetch();
//    	
//    	Long total = Optional.ofNullable(commonQuery.clone()
