package teamdevhub.devhub.common.logging;
...
public class LoggingAspect {
    ...
    @Around("execution(* teamdevhub.devhub..adapter.in..*(..)) || " +
            "execution(* teamdevhub.devhub..adapter.out..*(..)) || " +
            "execution(* teamdevhub.devhub..application..*(..)) ")
