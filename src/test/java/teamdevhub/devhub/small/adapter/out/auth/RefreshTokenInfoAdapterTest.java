...
class RefreshTokenInfoAdapterTest {
    ...
    void saveRefreshTokenIfNotExists() {
        // given
        RefreshTokenInfo refreshTokenInfo = RefreshTokenInfo.of(TEST_USER_GUID_1, TOKEN_1);

        // when
        refreshTokenAdapter.save(refreshTokenInfo);

        // then
        RefreshTokenInfo foundRefreshTokenInfo = refreshTokenAdapter.findByUserGuid(TEST_USER_GUID_1);
        assertThat(foundRefreshTokenInfo.token()).isEqualTo(TOKEN_1);
    }
    ...
    void rotateIfRefreshTokenExists() {
        // given
        refreshTokenAdapter.save(RefreshTokenInfo.of(TEST_USER_GUID_1, TOKEN_1));

        // when
        refreshTokenAdapter.save(RefreshTokenInfo.of(TEST_USER_GUID_1, TOKEN_2));

        // then
        RefreshTokenInfo foundRefreshTokenInfo = refreshTokenAdapter.findByUserGuid(TEST_USER_GUID_1);
        assertThat(foundRefreshTokenInfo.token()).isEqualTo(TOKEN_2);
    }
