...
import teamdevhub.devhub.application.oauth.CompositeOauthProviderSelector;
...
public class CompositeOauthProviderSelectorTest {

    private CompositeOauthProviderSelector compositeOauthProviderSelector;
    ...
    void init() {
        ...
        compositeOauthProviderSelector = new CompositeOauthProviderSelector(List.of(githubOauthClient, googleOauthClient));
    }
    ...
    void select_githubProvider_returnsGithubClient() {
        // given, when
        OauthClient selectedOauClient = compositeOauthProviderSelector.select(VerificationProvider.GOOGLE);
    ...
    void select_unsupportedProvider_throwsException() {
        // given, when, then
        assertThatThrownBy(
                () -> compositeOauthProviderSelector.select(VerificationProvider.KAKAO))
