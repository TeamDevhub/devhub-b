...
@SpringBootTest
@Transactional
class RefreshTokenInfoAdapterMediumTest {
    ...
    void saveRefreshToken() {
        // given
        RefreshTokenInfo refreshTokenInfo = RefreshTokenInfo.of("USER_GUID_1", "REFRESH_TOKEN_1");
    ...
    void saveRefreshToken_rotate() {
        ...
        RefreshTokenInfo refreshTokenInfo = RefreshTokenInfo.of("USER_GUID_1", "NEW_REFRESH_TOKEN");
    ...
    void findByUserGuid() {
        ...
        // when
        RefreshTokenInfo refreshTokenInfo = refreshTokenAdapter.findByUserGuid("USER_GUID_1");

        // then
        assertThat(refreshTokenInfo.userGuid()).isEqualTo("USER_GUID_1");
        assertThat(refreshTokenInfo.token()).isEqualTo("REFRESH_TOKEN_1");
    }
