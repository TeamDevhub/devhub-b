...
class BCryptPasswordPolicyProviderMediumTest {
    ...
    void init() {
        ...
        bCryptPasswordPolicyProvider = new BCryptPasswordPolicyProvider(passwordEncoder);
    }
    ...
    void encodedPasswordHasValidBCryptFormat() {
        // given
        String hashedPassword = bCryptPasswordPolicyProvider.encode(TEST_PASSWORD_1);
