...
class UserCredentialAdapterTest {
    ...
    void saveEmailUserCredential_savedToDb() {
        // given
        UserCredential userCredential = UserCredential.of(TEST_USER_GUID_1, TEST_EMAIL_1, UserRole.USER);

        // when
        userCredentialAdapter.saveEmailUserCredential(userCredential, TEST_PASSWORD_1);
    ...
    void findEmailUserCredentialByEmail_found() {
        ...
        // when
        Optional<UserCredential> result = userCredentialAdapter.findEmailUserCredentialByEmail(TEST_EMAIL_1);
    ...
    void findEmailUserCredentialByEmail_notFound_returnsEmpty() {
        // when
        Optional<UserCredential> result = userCredentialAdapter.findEmailUserCredentialByEmail("notexist@email.com");
    ...
    void findEmailUserCredentialByUserGuid_found() {
        ...
        // when
        Optional<UserCredential> result = userCredentialAdapter.findEmailUserCredentialByUserGuid(TEST_USER_GUID_1);
    ...
    void findEmailUserCredentialByUserGuid_notFound_returnsEmpty() {
        // when
        Optional<UserCredential> result = userCredentialAdapter.findEmailUserCredentialByUserGuid("NOT_EXIST_GUID");
    ...
    void saveOAuthUserCredential_savedToDb() {
        ...
        // when
        userCredentialAdapter.saveOAuthUserCredential(userCredential, VerificationProvider.GOOGLE, TEST_OAUTH_ID_1);
    ...
    void findOAuthUserCredentialByOAuth_found() {
        ...
        // when
        Optional<UserCredential> result = userCredentialAdapter.findOAuthUserCredentialByOAuth(VerificationProvider.GOOGLE, TEST_OAUTH_ID_1);
    ...
    void findOAuthUserCredentialByOAuth_notFound_returnsEmpty() {
        // when
        Optional<UserCredential> result = userCredentialAdapter.findOAuthUserCredentialByOAuth(VerificationProvider.GOOGLE, "not-exist-id");
    ...
    void saveOAuthUserCredential_differentProviders_storedSeparately() {
        // given
        UserCredential googleCredential = UserCredential.of(TEST_USER_GUID_1, TEST_EMAIL_1, UserRole.USER);
        UserCredential githubCredential = UserCredential.of(TEST_USER_GUID_2, TEST_EMAIL_2, UserRole.USER);
        ...
        // when
        Optional<UserCredential> google = userCredentialAdapter.findOAuthUserCredentialByOAuth(VerificationProvider.GOOGLE, TEST_OAUTH_ID_1);
        Optional<UserCredential> github = userCredentialAdapter.findOAuthUserCredentialByOAuth(VerificationProvider.GITHUB, TEST_OAUTH_ID_1);
