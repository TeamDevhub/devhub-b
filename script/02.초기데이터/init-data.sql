...
-- USER_STATUS
('7001', '정상', 'USER_STATUS', 1, 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM', ''),
('7002', '탈퇴', 'USER_STATUS', 2, 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM', ''),
('7003', '정지', 'USER_STATUS', 3, 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM', '');
